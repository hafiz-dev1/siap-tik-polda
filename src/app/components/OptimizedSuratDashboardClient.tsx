// file: app/components/OptimizedSuratDashboardClient.tsx
'use client';
...
export default function OptimizedSuratDashboardClient({ suratId, suratList, role }: Props) {
